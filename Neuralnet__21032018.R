...
test_iris <- iris #örneklemin tamamında test ediyoruz $$$ BUNU KULLANMA USTTEKİ DOĞRU $$$
...
pred_test <- compute(iris_n,test_iris[,2:57]) # predictionlarımızı test ediyoruz
