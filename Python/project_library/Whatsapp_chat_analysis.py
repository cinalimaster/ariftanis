# Python libraries that we need for this task
import regex
import pandas as pd
import numpy as np
import emoji
...
# a few Python functions to prepare the data before importing it:
def date_time(s):
...
# last 20 messages and some other insights from the data:
...
# prepare a visualization of the total emojis present in the chat and the type of emojis sent between the two people. 
