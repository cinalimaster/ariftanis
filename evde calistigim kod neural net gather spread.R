...
#kolon adýný ilk satýrla deðiþtirme
...
#DATA FRAME i düzenledim ve neuralnet ile çalýþabilir hale getirdim önce parçaladým sonra birleþtireceðim
...
#kolonlarý birleþtirip yeni dataframe oluþturma with dplyr
